...
npx --yes skills@1.7.0 add https://tinycloud.chat/agents/tinychat-retrieval/0.1.1-onboarding.16/tinychat-retrieval-0.1.1-onboarding.16.tgz --skill tinychat-retrieval --global --copy --agent opencode --yes
```
...
The release includes [skill instructions](tinychat-retrieval/0.1.1-onboarding.16/SKILL.md), [setup recovery](tinychat-retrieval/0.1.1-onboarding.16/references/setup.md), [meeting commands](tinychat-retrieval/0.1.1-onboarding.16/references/meetings.md), [local session handoff](tinychat-retrieval/0.1.1-onboarding.16/references/session-handoff.md), [permissions](tinychat-retrieval/0.1.1-onboarding.16/assets/permissions.json), [runtime metadata](tinychat-retrieval/0.1.1-onboarding.16/pack.json) and [release hashes](tinychat-retrieval/0.1.1-onboarding.16/release.json).
...
Browsing/history uses `discover` with metadata pages and `read` with a displayed 1-based meeting selection, then the same `next` flow. Other clients use `node PACK/scripts/consume.mjs`; see [meeting commands](tinychat-retrieval/0.1.1-onboarding.16/references/meetings.md). Resolve PACK from the known installed directory.
...
Follow the installed [session handoff workflow](tinychat-retrieval/0.1.1-onboarding.16/references/session-handoff.md). This local request does not authorize `tc share publish`, upload retries, extra consent or scope changes. Remote publishing is a separate explicit request. Never put raw messages, command bodies, provider records, keys, signed responses or TUI input history into the handoff.
