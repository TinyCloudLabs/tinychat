...
| `REDPILL_DEFAULT_MODEL` | `deepseek/deepseek-v4-flash` (must stay an offered model — a non-offered value warns and falls back at runtime; `backend/src/routes/chat.ts` ST11) |
