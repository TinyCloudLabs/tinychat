...
npx --yes skills@{{INSTALLER_VERSION}} add https://tinycloud.chat/agents/tinychat-retrieval/{{PACK_VERSION}}/tinychat-retrieval-{{PACK_VERSION}}.tgz --skill tinychat-retrieval --global --copy --agent CLIENT --yes
```
